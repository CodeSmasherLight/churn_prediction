...
if page == 'Prediction':
    ...
    # Add tenure_group based on tenure
    ...
    if st.button('Predict Churn'):
        ...
        with col1:
            # Display the churn probability as a percentage
        ...
        # Show retention recommendations based on the prediction
        if prediction[0] == 1:
            st.subheader("Retention Recommendations")
            
            # Get top influencers for churn prediction
            if hasattr(model[-1], 'feature_importances_'):
                # If the model has builtin feature importances
                ...
                # Display recommendations based on top features
...
#         ### Model
#         XGBoost classifier with {metrics_df.loc[metrics_df['Metric'] == 'Accuracy', 'Value'].values[0]:.2%} accuracy and {metrics_df.loc[metrics_df['Metric'] == 'ROC AUC', 'Value'].values[0]:.2f} ROC AUC score.
#     """)
